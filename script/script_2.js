...
function chooseAnswer(selectedAnswer) {
    ...
    console.log('selected Question number is', chosenAnswerNumber);
    console.log('right Answer is', question['right_answer']) //so herausfinden welche Antwort die richtige ist
...
function resetGivenAnswer() {
    ...
    // document.getElementById('answer_4').classList.remove('bg-success');
      ...
      // Remove background color classes from answer_options elements
  ...
  // Remove background color classes from question_letter elements within answer_options
